...
import { falcon512, falcon512paddedOpts, genFalcon } from "@noble/post-quantum/falcon.js"
...
if (F_INV !== Number(invert(BigInt(N), BigInt(Q)))) {
  throw new Error("Falcon-512 F_INV drift")
}
...
const falcon512paddedEth = genFalcon({
  ...falcon512paddedOpts,
